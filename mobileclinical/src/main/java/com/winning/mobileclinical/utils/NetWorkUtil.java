        ...
        public void run()
        {
            ...
            try
            {
                ...
                Message msgUpdateConnection = Message.obtain(mHandler,
                        GlobalCache.MSG_UPDATE_CONNECTION_TIME);
                ...
                while ((currentByte = stream.read()) != -1)
                {
                    bytesIn++;
                    bytesInThreshold++;
                    if (updateDelta >= GlobalCache.UPDATE_THRESHOLD)
                    {
                        int progress = (int) ((bytesIn / (double) EXPECTED_SIZE_IN_BYTES) * 100);
                        Message msg = Message.obtain(mHandler, GlobalCache.MSG_UPDATE_STATUS,
                ...
                Message msg = Message.obtain(mHandler, GlobalCache.MSG_COMPLETE_STATUS,
